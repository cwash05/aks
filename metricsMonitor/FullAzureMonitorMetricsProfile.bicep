...
var clusterResourceGroup = resourceGroup().name
...
var nodeRecordingRuleGroupNameWin = 'NodeRecordingRulesRuleGroupWin-${clusterName}'
var nodeRecordingRuleGroupDescription = 'Node Recording Rules RuleGroup'
var nodeRecordingRuleGroupDescriptionWin = 'Node Recording Rules RuleGroup Windows'
var kubernetesRecordingRuleGroupName = 'KubernetesReccordingRulesRuleGroup-${clusterName}'
var kubernetesRecordingRuleGroupNameWin = 'KubernetesReccordingRulesRuleGroupWin-${clusterName}'
var kubernetesRecordingRuleGroupDescription = 'Kubernetes Recording Rules RuleGroup'
var kubernetesRecordingRuleGroupDescriptionWin = 'Kubernetes Recording Rules RuleGroup Windows'
var version = ' - 0.1'
...
resource nodeRecordingRuleGroupWin 'Microsoft.AlertsManagement/prometheusRuleGroups@2021-07-22-preview' = {
  name: nodeRecordingRuleGroupNameWin
  location: azureMonitorWorkspaceLocation
  properties: {
    description: '${nodeRecordingRuleGroupDescriptionWin}-${version}'
    scopes: [
      azureMonitorWorkspaceResourceId
    ]
...
resource nodeAndKubernetesRecordingRuleGroupWin 'Microsoft.AlertsManagement/prometheusRuleGroups@2021-07-22-preview' = {
  name: kubernetesRecordingRuleGroupNameWin
  location: azureMonitorWorkspaceLocation
  properties: {
    description: '${kubernetesRecordingRuleGroupDescriptionWin}-${version}'
    scopes: [
      azureMonitorWorkspaceResourceId
    ]
    enabled: enableWindowsRecordingRules
