...
param app_gatewway_sub_name string = 'appgateway-sub'
...
param app_gateway_prefix string ='10.2.21.0/24'
  ...
  properties: {
    ...
    addonProfiles: {
      ...
      ingressApplicationGateway: {
        enabled: true
        config: {
          applicationGatewayName: '${aksPrefix}-ingress-appgateway'
          subnetPrefix: app_gateway_prefix
        }
      }
    }
    enableRBAC: true
