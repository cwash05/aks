...
resource aks_cluster 'Microsoft.ContainerService/managedClusters@2022-10-02-preview' = {
  name: cluster_name
  dependsOn:[
    ccpNetAdminRole
    subContributorRole
...
resource win_node_pool 'Microsoft.ContainerService/managedClusters/agentPools@2022-08-03-preview' = {
  parent: aks_cluster
